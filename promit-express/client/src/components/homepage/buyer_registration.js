...
import '../../css/buyer/registration.css';
...
export default class BuyerRegistration extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            log_email: 'buyer123@gmail.com',
            log_pass: 'buyer123@gmail.com',
    ...
    handleSubmitLogin = (ev) => {
                ...
                axios.get(`/api/buyer/login?email=${this.state.log_email}&password=${this.state.log_pass}`)
                    .then(function (response) {
                        if (response.data) {
                            Swal.fire({
                                title: 'Welcome ' + response.data.name,
                                text: 'Start buying products!!!',
                                icon: 'success',
                                confirmButtonColor: '#3085d6',
                                confirmButtonText: 'OK'
                            }).then((result) => {
    ...
    render() {
            return(this.state.user_signed_in) ? (<BuyerDashboard current_seller_data={this.state.current_seller_data} />) : (
                <div class="main">

                    <h1 className="form-title seller-intro"> BUYER REGISTRATION </h1>
                    <br />
                                ...
                                <div class="signup-form">
                                    ...
                                    <form onSubmit={(ev) => { this.handleSubmitRegistration(ev) }} class="register-form" id="register-form">
                                        ...
                                        <div class="form-group form-button">
                                            <input type="submit" name="signup" id="signup-buyer" className="form-submit btn btn-danger btn-xl text-uppercase js-scroll-trigger" value="Register" />
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="signin-content">
                                ...
                                <div class="signin-form">
                                    ...
                                    <form onSubmit={(ev) => { this.handleSubmitLogin(ev) }} class="register-form" id="login-form">
                                        ...
                                        <div class="form-group form-button">
                                            <input type="submit" name="signin" id="signin-buyer" className="form-submit btn btn-danger btn-xl text-uppercase js-scroll-trigger" value="Log in" />
                                        </div>
                                    </form>
