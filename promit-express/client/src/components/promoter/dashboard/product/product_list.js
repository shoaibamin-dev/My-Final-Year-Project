...
//   console.log("CURSTATE",states)
  ...
  const handlePromotion = () =>{
    props.handlePromotion(props.product);
  }
  ...
  return (
    ...
    {props.product.pictures_id.map((elem,index)=>{
      ...
      <CardActions>
        <Button onClick={()=>handlePromotion()} variant="contained" size="small" color="primary" style={{marginLeft:'auto',marginRight:'auto', marginTop:0, marginBottom:0, paddingTop:10, paddingBottom:10}}>
