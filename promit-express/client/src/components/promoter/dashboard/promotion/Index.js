...
export default function IndexPromotion(props) {
  ...
  const loadPromotions = () => {
    ...
    if (!states.isLoaded) {
      ...
      axios.get(`/api/promotion/get_promotions?promotions=${props.current_seller_data.promoting_products}`).then((res) => {

        const promotions_result = res.data.promotions_list
